window.NexarviaAPI = (() => {
  ...
  return {
    ...
    opsHealth: ()=>request("/api/ops/health"),
    opsJobs: ()=>request("/api/ops/jobs"),
    opsAudit: ()=>request("/api/ops/audit"),
    queueJob: (body)=>request("/api/ops/jobs",{method:"POST",body:JSON.stringify(body)}),
